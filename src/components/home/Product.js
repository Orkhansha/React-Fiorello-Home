...
<div className="row">
    <div className="col-sm-6 col-md-4 col-lg-3 mt-3">
        <div className="product-item text-center" data-id="popular">
            <div className="img">
                <a href="">
                    <img src={require('../../img/shop-14-img.jpg')} className="img-fluid" alt=""/>
                </a>
            </div>
    ...
    <div className="col-sm-6 col-md-4 col-lg-3 mt-3">
        <div className="product-item text-center" data-id="popular">
            <div className="img">
                <a href="">
                    <img src={require('../../img/shop-13-img.jpg')} className="img-fluid" alt=""/>
                </a>
            </div>
            <div className="title mt-3">
                <h6>MAJESTY PALM</h6>
    ...
    <div className="col-sm-6 col-md-4 col-lg-3 mt-3">
        <div className="product-item text-center" data-id="winter">
            <div className="img">
                <a href="">
                    <img src={require('../../img/shop-12-img.jpg')} className="img-fluid" alt=""/>
                </a>
            </div>
            <div className="title mt-3">
                <h6>MAJESTY PALM</h6>
    ...
    <div className="col-sm-6 col-md-4 col-lg-3 mt-3">
        <div className="product-item text-center" data-id="winter">
            <div className="img">
                <a href="">
                    <img src={require('../../img/shop-11-img.jpg')} className="img-fluid" alt=""/>
                </a>
            </div>
            <div className="title mt-3">
                <h6>MAJESTY PALM</h6>
    ...
    <div className="col-sm-6 col-md-4 col-lg-3 mt-3">
        <div className="product-item text-center" data-id="various">
            <div className="img">
                <a href="">
                    <img src={require('../../img/shop-10-img.jpg')} className="img-fluid" alt=""/>
                </a>
            </div>
            <div className="title mt-3">
                <h6>MAJESTY PALM</h6>
    ...
    <div className="col-sm-6 col-md-4 col-lg-3 mt-3">
        <div className="product-item text-center" data-id="various">
            <div className="img">
                <a href="">
                    <img src={require('../../img/shop-9-img.jpg')} className="img-fluid" alt=""/>
                </a>
            </div>
            <div className="title mt-3">
                <h6>MAJESTY PALM</h6>
    ...
    <div className="col-sm-6 col-md-4 col-lg-3 mt-3">
        <div className="product-item text-center" data-id="exotic">
            <div className="img">
                <a href="">
                    <img src={require('../../img/shop-8-img.jpg')} className="img-fluid" alt=""/>
                </a>
            </div>
            <div className="title mt-3">
                <h6>MAJESTY PALM</h6>
    ...
    <div className="col-sm-6 col-md-4 col-lg-3 mt-3">
        <div className="product-item text-center" data-id="exotic">
            <div className="img">
                <a href="">
                    <img src={require('../../img/shop-7-img.jpg')} className="img-fluid" alt=""/>
                </a>
            </div>
            <div className="title mt-3">
                <h6>MAJESTY PALM</h6>
